...
const CUSTOM_FIELDS = [
  ...
  { key: 'last_show_attended', name: 'Last Show Attended', dataType: 'TEXT', model: 'contact' },
  {
    ...
    dataType: 'SINGLE_OPTIONS',
    model: 'contact',
    options: ['Not Started', 'Pending Weather Check', 'Approved to Ship', 'Label Created', 'In Transit', 'Delivered', 'LAG Confirmed'],
  },
];
...
const DEMO_CONTACTS = [
  {
    ...
    phone: '+14045550101',
    postalCode: '75201',
    tags: ['source:show-qr', 'show:narbc-arlington-2026', 'interest:crested-gecko', 'status:hot-lead'],
    fields: {
  ...
  },
  {
    ...
    phone: '+14045550102',
    postalCode: '85001',
    tags: ['source:morphmarket', 'interest:crested-gecko', 'shipping:pending-weather-check', 'status:customer'],
    fields: {
      species_interest: 'Crested Gecko',
  ...
  },
  {
    ...
    phone: '+14045550103',
    postalCode: '60601',
    tags: ['source:instagram', 'interest:crested-gecko', 'status:new-lead'],
    fields: {
      species_interest: 'Crested Gecko',
  ...
  },
  {
    ...
    phone: '+14045550104',
    postalCode: '30339',
    tags: ['source:show-qr', 'show:southeast-reptile-expo-2026', 'interest:crested-gecko', 'status:new-lead'],
    fields: {
      species_interest: 'Crested Gecko',
  ...
  },
  {
    ...
    phone: '+14045550105',
    postalCode: '10001',
    tags: ['source:referral', 'interest:crested-gecko', 'status:customer', 'shipping:approved'],
    fields: {
      species_interest: 'Crested Gecko',
  ...
  },
  {
    ...
    phone: '+14045550106',
    postalCode: '98101',
    tags: ['source:website', 'interest:leopard-gecko', 'status:customer', 'review-requested'],
    fields: {
...
async function upsertContact(config, demo) {
  ...
  if (existing) {
    const response = await ghl.put(`/contacts/${existing.id}`, payload);
